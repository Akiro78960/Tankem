	...
	class AjaxNiveauFavori extends CommonAction{
		...
		protected function executeAction() {
			...
			try{
				...
				$statement = $this->connection->prepare("SELECT COUNT(idNiveau) as Count, idNiveau FROM partie WHERE IdJoueur1 = ? or IdJoueur2 = ? GROUP BY idNiveau ORDER by Count DESC");
