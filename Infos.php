	  ...
	  <div class="row text-center w-100 mx-auto" id="fixedcontainer">
		<div class="col-md-11 text-center mx-auto">
		  <form class="" action ="Infos.php" method ="post">
			...
			<div class="form-group w-25" id="labelPassword"> <label>Password</label> <input type="password" name="fieldPassword" class="form-control" placeholder="Password"> </div>
			...
			<div class="form-group w-25" id="labelReEnterPassword"> <label>Re-enter&nbsp;Password</label> <input type="password" name="fieldConfirmPassword" class="form-control" placeholder="Re-enter Password"> </div>
