...
class MenuPrincipal:
    def __init__(self):
		...
		image2 =Image.open('C:/Users/0873247/Desktop/TANKEM/tankemv4.20/Tankem/asset/Menu/background.jpg')
		image1 = ImageTk.PhotoImage(image2)
		w = image1.width()
		h = image1.height()

		label1 = Label(this.root,image=image1,x =0,y=0)
		label1.pack()

		self.root.title ("Tank'em !")
		self.root.resizable(width=FALSE, height=FALSE)
		self.root.geometry("812x610+100+100")
